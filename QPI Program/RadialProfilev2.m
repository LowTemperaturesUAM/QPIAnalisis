...
function [RadialProfile, ValoresValidos] = RadialProfilev2(TamanhoReal, Center,  Matrix, NOfPoints, MaximumRadius)
    ...
    ValoresValidos = linspace(0,MaximumRadius,(TamanhoImagen/2)/SizeOfRings)';
